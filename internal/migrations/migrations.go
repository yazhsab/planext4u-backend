...
var serviceOrder = []string{"platform", "audit", "catalog", "commerce", "inventory", "payment", "ordering", "booking", "supply", "food", "fulfillment", "social", "governance", "local_verticals", "emergency", "wallet", "configuration", "admin", "identity", "media", "messaging", "notification"}
...
func validateOwnership(migration Migration) error {
	allSchemas := []string{"identity", "configuration", "admin", "catalog", "commerce", "inventory", "payment", "ordering", "booking", "supply", "food", "fulfillment", "social", "governance", "local_verticals", "emergency", "wallet", "media", "audit", "messaging", "notification"}
