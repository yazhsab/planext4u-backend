...
var serviceOrder = []string{"platform", "audit", "catalog", "commerce", "inventory", "payment", "ordering", "booking", "supply", "food", "fulfillment", "social", "governance", "local_verticals", "emergency", "wallet", "support", "configuration", "admin", "customer_web", "identity", "media", "messaging", "notification"}
...
func validateOwnership(migration Migration) error {
	allSchemas := []string{"identity", "configuration", "admin", "customer_web", "catalog", "commerce", "inventory", "payment", "ordering", "booking", "supply", "food", "fulfillment", "social", "governance", "local_verticals", "emergency", "wallet", "support", "media", "audit", "messaging", "notification"}
