...
var serviceOrder = []string{"platform", "audit", "catalog", "commerce", "inventory", "payment", "ordering", "booking", "wallet", "configuration", "identity", "media", "messaging", "notification"}
...
func validateOwnership(migration Migration) error {
	allSchemas := []string{"identity", "configuration", "catalog", "commerce", "inventory", "payment", "ordering", "booking", "wallet", "media", "audit", "messaging", "notification"}
