...
var serviceOrder = []string{"platform", "audit", "catalog", "commerce", "inventory", "payment", "ordering", "booking", "supply", "food", "fulfillment", "social", "local_verticals", "emergency", "wallet", "configuration", "identity", "media", "messaging", "notification"}
...
func validateOwnership(migration Migration) error {
	allSchemas := []string{"identity", "configuration", "catalog", "commerce", "inventory", "payment", "ordering", "booking", "supply", "food", "fulfillment", "social", "local_verticals", "emergency", "wallet", "media", "audit", "messaging", "notification"}
