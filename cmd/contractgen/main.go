...
var fixtures = []fixture{
	...
	{goName: "ClassifiedListingFixtureJSON", dartName: "classifiedListingFixtureJson", path: "api/fixtures/classified_listing.json"},
	{goName: "DomainEventFixtureJSON", dartName: "domainEventFixtureJson", path: "api/fixtures/domain_event.json"},
	{goName: "EmergencyRequestFixtureJSON", dartName: "emergencyRequestFixtureJson", path: "api/fixtures/emergency_request.json"},
	{goName: "FoodOrderFixtureJSON", dartName: "foodOrderFixtureJson", path: "api/fixtures/food_order.json"},
	{goName: "GovernanceDashboardFixtureJSON", dartName: "governanceDashboardFixtureJson", path: "api/fixtures/governance_dashboard.json"},
	{goName: "HomeListingFixtureJSON", dartName: "homeListingFixtureJson", path: "api/fixtures/home_listing.json"},
...
func run(root string, check bool) error {
	for _, contractPath := range []string{
		...
		"api/openapi/local_verticals.openapi.json",
